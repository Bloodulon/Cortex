...
function renderOptions(q) {
  ...
  q.options.forEach((opt, i) => {
    ...
    btn.className =
      "w-full py-3 px-4 bg-surface-container-highest border border-white/10 rounded-xl text-sm font-semibold text-left flex items-center gap-3 transition-all active:scale-95";
